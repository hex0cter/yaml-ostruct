...
class TestYamlOstructInstanceWithoutPath < Minitest::Test
  def test_fox
    yaml_sugar = YamlOstruct.new
    yaml_sugar.load('config', omit_path: true)
  ...
  def test_overwriting
    yaml_sugar = YamlOstruct.new
    yaml_sugar.load('config', omit_path: true)
    yaml_sugar.load('config/overwritting/animal', omit_path: true)
    yaml_sugar.load('config/overwritting/bird', omit_path: true)
  ...
  def test_merging
    ...
    yaml_sugar.load('config', omit_path: true)
    yaml_sugar.load('config/overwritting/animal', omit_path: true)
    yaml_sugar.load('config/overwritting/bird', omit_path: true, deep_merge: true)
  ...
  def test_multiple_instances
    ...
    animal_config.load('config/overwritting/animal', omit_path: true)
    bird_config.load('config/overwritting/bird', omit_path: true)
